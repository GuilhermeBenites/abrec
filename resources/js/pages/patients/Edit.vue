...
const toggles = reactive({
    is_diabetic: props.patient.is_diabetic,
    is_hypertensive: props.patient.is_hypertensive,
    has_kidney_problem: props.patient.has_kidney_problem,
    has_family_drc: props.patient.has_family_drc,
    is_obese: props.patient.is_obese,
    has_back_eye_exam: props.patient.has_back_eye_exam,
});
</script>
                        ...
                        >
                            ...
                            >
                                ...
                                <Toggle
                                    ...
                                    v-model="toggles.is_hypertensive"
                                />
                            </div>
                            <div
                                class="flex items-center justify-between p-4 transition-colors hover:bg-muted/50"
                            >
                                ...
                                <Toggle
                                    name="has_kidney_problem"
                                    v-model="toggles.has_kidney_problem"
                                />
                            </div>
                            <div
                                class="flex items-center justify-between p-4 transition-colors hover:bg-muted/50"
                            >
                                ...
                                <Toggle
                                    name="has_family_drc"
                                    v-model="toggles.has_family_drc"
                                />
                            </div>
                            <div
                                class="flex items-center justify-between p-4 transition-colors hover:bg-muted/50"
                            ...
                            >
                                ...
                                <Toggle
                                    name="has_back_eye_exam"
                                    v-model="toggles.has_back_eye_exam"
                                />
                            </div>
                        </div>
